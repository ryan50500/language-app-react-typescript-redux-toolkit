    ...
    return (
        <div key={teacher.id} className={`${styles.card}`}>
            <div className={styles.teacher}>
                <h4 className={styles.teacher__name}>{teacher.name}<img style={{ paddingLeft: '10px', width: '34px' }} src={teacher.flag}></img></h4>
                <h4>Teaches: {teacher.language}
                    {teacher.native ? (
                ...
                <h5>Time availabile: {teacher.time}</h5>
                <h5>Days availabile: {teacher.days}</h5>
                <h5 className={styles.price}>Price: £{teacher.price} per hour</h5>
            </div>
            <div className={styles.teacher__contact}>
                ...
                <div className={styles.teacher__flex__baseline}>
                    <div><span style={{ fontSize: '15px', fontWeight: '100' }}>{teacher.reviews}</span><span style={{ fontSize: '13.5px', color: 'gray', paddingLeft: '5px' }}>reviews</span></div>
