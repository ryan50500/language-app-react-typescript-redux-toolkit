                ...
                <div className={styles.hover__container}>
                    ...
                    <div>
                        ...
                        <div className={styles.hover__slots}>
                            <div className={styles.hover__each__slot} style={{ color: time === 'morning' ? '#3bb3bd' : "" }} onClick={() => handleTimeChange('morning')} >
                            ...
                            <div className={styles.hover__each__slot} style={{ color: time === 'afternoon' ? '#3bb3bd' : "" }} onClick={() => handleTimeChange('afternoon')}>
                            ...
                            <div className={styles.hover__each__slot} style={{ color: time === 'evening' ? '#3bb3bd' : "" }} onClick={() => handleTimeChange('evening')}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={styles.svgIcon}> <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path> </svg>
